...
<html lang="en">
    ...
    <head>
        ...
        <script src="<?=base_url('public/assets/libs/datatables.net/js/jquery.dataTables.min.js'); ?>"></script>
         ...
         <link rel="stylesheet" href="<?=base_url('public/assets/libs/jquery-confirm/css/jquery-confirm.css'); ?>">
       ...
       <link rel="stylesheet" href="<?=base_url('public/assets/libs/select2/css/select2.min.css'); ?>">
